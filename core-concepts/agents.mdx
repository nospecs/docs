...
policy\_manager.add\_policy(read\_only\_policy)
policy\_manager.assign\_policy(agent\_a.agent\_id, "ReadOnlyPolicy")
\`\`
```
***
...
monitor.track\_agent(agent\_a.agent\_id)
monitor.generate\_report(agent\_a.agent\_id)
\`\`
```
***
